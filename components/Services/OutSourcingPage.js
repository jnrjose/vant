...
const enterpriseData = [
  {
    ...
    messageOne:
      "We believe that every industry depends on its people – on their expertise, training, attitudes and commitment, and as such, we are committed to ensuring that we relieve our client of the extra burden that comes with contract personnel management, by offering a comprehensive range of services including mobilization, payrolling, medical insurance, taxation and more.",
  ...
  // {
  //   header: "Finance Support Services",
  //   messageOne:
  //     "With constant fluctuating market dynamics, organizations have the responsibility to maintain the current status quo and increase value. This can be daunting for executives, as they have to meet targets despite current market trends.",
  //   messageTwo:
  //     "We offer a full financial support team to help organizations meet their goals. From offering loans to managing reports and accounting, we assist with evaluation, analysis, and support on the best decisions for your business.",
  //   imageUrl: "/enterprisepics2.png",
  // },
];
  ...
  return (
    <div>
      <div className="strategy-container">
        <div className="strategyhero-container">
          ...
          <div className="strategyintro-container">
            <h5>Outsourcing and Support</h5>
            <p>
              At Vantegral Consulting, we offer quality and cost-effective
              outsourcing solutions, following a systematic process to proffer
              contracting personnel management solutions to our clients.
            </p>
          </div>
      ...
      <div className="next-section">
        <h6>
          Next Section: <span>Empowerment</span>
        </h6>
        <p>A glimpse into how we think</p>

        <div>
          <ActiveLink href="/services/empowerment">
